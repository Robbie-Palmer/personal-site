...
export function TechMobileNav({ technologies }: TechMobileNavProps) {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        ...
        >
          ...
          <span className="hidden min-[380px]:inline">Tech</span>
          <span className="sr-only min-[380px]:hidden">Technologies Menu</span>
        </Button>
      </SheetTrigger>
      <SheetContent side="left" className="w-[300px] sm:w-[350px] pr-0">
        <div className="sr-only">
          <SheetTitle>Technology Navigation Menu</SheetTitle>
        </div>
        <TechNavContent
