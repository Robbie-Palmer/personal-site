...
export const recipes: RecipeContent[] = [
  ...
  {
    title: "Chicken Risotto with Red Pesto & Rosemary",
    slug: "chicken-risotto-red-pesto-rosemary",
    description:
    ...
    ingredientGroups: [
      {
        items: [
          ...
          },
          {
            ...
            amount: 100,
            unit: "g",
            note: "half grated, half shavings",
          },
          {
            ingredient: "salt",
            amount: 1,
  ...
  {
    title: "Salt and Chilli Chips",
    slug: "salt-and-chilli-chips",
    description: "Chinese takeaway style salt and chilli chips.",
    date: "2026-02-12",
    tags: ["fakeaway", "spicy"],
    cuisine: "Chinese",
    servings: 2,
    ...
    ingredientGroups: [
      {
        name: "Spice Mix",
        items: [
          { ingredient: "msg", amount: 1, unit: "tsp" },
          { ingredient: "five-spice", amount: 1, unit: "tsp" },
          { ingredient: "white-pepper", amount: 1, unit: "tsp" },
          { ingredient: "cayenne-pepper", amount: 0.5, unit: "tsp" },
          { ingredient: "hot-chilli-powder", amount: 0.5, unit: "tsp" },
          { ingredient: "chilli-flakes", amount: 0.5, unit: "tsp" },
      ...
      },
      {
        name: "Main",
        items: [
          { ingredient: "chips", amount: 500, unit: "g" },
          {
            ingredient: "onion",
            amount: 1,
            unit: "piece",
          ...
          { ingredient: "vegetable-oil", amount: 1, unit: "tbsp" },
        ],
      },
    ],
    instructions: [
      "Mix all the spices, sugar, and salt together in a small bowl.",
      "Cook the chips according to package instructions (air fryer recommended for crispiness).",
      "While chips are cooking, heat oil in a wok or large frying pan over high heat.",
      "Stir-fry the onion, peppers, fresh chilli, and garlic for 2-3 minutes until softened but still crisp.",
      "Add the cooked chips to the wok.",
      "Sprinkle the spice mix over the chips and veg, tossing vigorously to coat everything evenly.",
      "Serve immediately.",
    ],
  },
];
