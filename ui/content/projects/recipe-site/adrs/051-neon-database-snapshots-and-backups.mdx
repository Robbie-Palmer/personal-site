...
Custom format produces a PostgreSQL archive rather than plain SQL or a general-purpose ZIP file. Its
table of contents lets `pg_restore` inspect and selectively restore objects, order dependent
