...
retain monthly archives for 400 days. Check that the monthly prefix is empty before promotion so a
manual retry can fill a missed month without creating duplicates; workflow concurrency serializes
the check and copy.
