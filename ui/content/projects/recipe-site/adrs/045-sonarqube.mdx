...
| **Codacy**                                    | Yes (PR check)               | Free OSS tier; one gate.                                                                              | Mainly wraps linters we already run (Biome) plus Semgrep; little net-new signal.             | Rejected: duplicates Biome without filling the health quadrant.                                                                 |
...
* Value for a single author is unproven. Maintainability metrics pay off mainly on multi-author
