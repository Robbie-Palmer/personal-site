...
a few megabytes each would bloat every clone and make git operations slow,
...
* **Decision**: Rejected. Good for experiment dashboards but does not solve the pipeline caching
...
* **Cons**: Less widely adopted than DVC or MLflow. Smaller community and fewer Stack Overflow
  ...
  operational overhead for a personal project. In practice ClearML adds comparatively little value
