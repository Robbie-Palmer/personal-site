...
household deletion is recorded once even when multiple members are notified.
...
* One event can fan out to multiple recipients without duplicating event data.
