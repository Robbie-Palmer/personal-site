...
* photo batches need an explicit mapping from many unordered images to multiple recipes;
...
Photo batches cannot assume one image equals one recipe because a recipe may span multiple pages.
