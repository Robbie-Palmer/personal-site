...
Authentication tells us **who** a user is. The authorization model must decide **what they are
allowed to do**.
...
organization/household primitive supplies the membership building block. The application still
needs its own authorization system.
