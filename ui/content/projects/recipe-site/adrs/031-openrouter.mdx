...
* **Pros**: Genuine OpenRouter-class product (catalogue + unified billing + retry), not a
  BYOK-only proxy. Pay-as-you-go with zero markup matches OpenRouter's economics. Native
