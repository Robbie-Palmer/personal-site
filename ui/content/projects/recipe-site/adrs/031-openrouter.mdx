...
* **Regulatory data residency or enterprise procurement requires first-party provider
  contracts** — e.g. an enterprise customer mandates all inference data stays within our
  infrastructure, or a compliance framework requires direct contracts with model providers.
  Layering Cloudflare AI Gateway in front, or going BYOK direct for the affected providers,
  is the response.
