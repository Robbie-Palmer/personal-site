...
* **Decision**: **Rejected.** The "multi-modality under one contract" angle would be
  ...
  remaining real differences are smaller LLM catalogue (\~30 vs OpenRouter's 60+), less
  granular routing controls, and EU data residency — only the last is a sometimes-real reason
  to revisit.
