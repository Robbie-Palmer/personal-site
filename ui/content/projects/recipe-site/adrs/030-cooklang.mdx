...
Cooklang occupies a specific role in our data model — it is not necessarily the final storage
format or the database schema:

- **Source of truth for content** — `.cook` files, authored via GUI, stored in git (or a future
...
- **Version history** — git today; event sourcing on extracted relational data if/when content
