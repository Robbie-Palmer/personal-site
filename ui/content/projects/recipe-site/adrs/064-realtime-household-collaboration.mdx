...
```json
{
  ...
  "pantry": {
    ...
    "revision": "42",
    "operationId": "0198...",
    "scope": { "type": "household", "household": { "id": "household_123", "name": "Home" } },
    "stock": { "onion": "fresh" },
...
Do not include session tokens, user details, or fields outside the authorized HTTP response. The
room rechecks the household-member list before delivery.
