...
Use **Cloudflare Workers (Paid) + Hono + Hyperdrive + Neon Postgres + Drizzle ORM** as the backend
...
| **Database**           | Neon Postgres     | Users, sessions, recipes, households, user-owned state     |
