...
change. A change can span multiple tables, indexes, constraints, and its required
...
Migrations do not run inside Worker startup or through Hyperdrive. One
serialized CI/CD migration runner exists, and its completion gates the application
deployment.
