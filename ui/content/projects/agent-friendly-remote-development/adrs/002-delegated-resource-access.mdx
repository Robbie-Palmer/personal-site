...
credential path. Isolate it per user, encrypt and back up it as sensitive state,
and show its wider authority. Do not claim that filesystem separation makes it
a narrow capability.
