...
* **Webpack**: The stable default. It is "boring" and reliable but considerably slower.
...
* **Performance**: Written in Rust, it is orders of magnitude faster than Webpack for startup and HMR, tighter [Short Feedback Loops](/projects?tab=philosophy#short-feedback-loops).
