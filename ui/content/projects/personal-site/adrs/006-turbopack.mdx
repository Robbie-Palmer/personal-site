...
* **Performance**: Written in Rust, it is orders of magnitude faster than Webpack for startup and HMR—tighter [Fast Feedback Loops](/projects?tab=philosophy#fast-feedback-loops).
