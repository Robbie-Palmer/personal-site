...
1. **[Minimize Platforms](/projects?tab=philosophy#minimize-platforms)**: The CI is the platform. Code, issues, PRs, and builds live in a single URL namespace. There is no "go to the CI dashboard" step—the logs are right in the Pull Request
