...
* **Node.js Test Runner**: Integrated but comparatively new and lacks the rich ecosystem of matchers and plugins found in Jest/Vitest.
...
* **Simplicity**: While it requires a `vitest.config.ts` (since we use Turbopack for development), the configuration is considerably lighter and more standard than a comparable Jest setup.
