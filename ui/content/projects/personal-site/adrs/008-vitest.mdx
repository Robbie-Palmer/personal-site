...
Vitest is a Vite-native unit test framework. Although we use distinct configurations ([ADR 006: Turbopack](/projects/personal-site/adrs/006-turbopack) for dev, Vitest for test), it aligns with the modern ecosystem and offers superior performance.
