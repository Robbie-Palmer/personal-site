...
* **Speed**: Powered by Vite and utilizing native ESM, it provides instant startup and hot module replacement (HMR) for tests. This tightens the "edit-test-debug" loop—[Fast Feedback Loops](/projects?tab=philosophy#fast-feedback-loops) in action.
