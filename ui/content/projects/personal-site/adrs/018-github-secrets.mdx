...
I want a solution that adheres to [Minimize Platforms](/projects?tab=philosophy#minimize-platforms) while encouraging **Short-lived Credentials**.
...
* **[Minimize Platforms](/projects?tab=philosophy#minimize-platforms)**: Secrets live where the code lives. No third-party dashboard to manage
