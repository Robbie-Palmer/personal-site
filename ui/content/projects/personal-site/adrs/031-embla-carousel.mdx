...
Notably, Embla provides a [**builder/playground**](https://www.embla-carousel.com/examples/generator/) on their website where you can generate and copy navigation code (buttons, dots, auto-scroll) directly into your codebase—similar to the **shadcn/ui** philosophy ([ADR 018](/projects/personal-site/adrs/018-shadcn)). This gives us ownership of the implementation rather than hiding it behind opaque library abstractions.
