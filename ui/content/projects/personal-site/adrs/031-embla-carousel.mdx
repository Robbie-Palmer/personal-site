...
This aligns with [Choose Boring Technologies](/projects?tab=philosophy#choose-boring-technologies) and [LLM-Optimized](/projects?tab=philosophy#llm-optimized). Embla is TypeScript-first, has clear documentation, and uses a composable hook-based API that AI agents understand well.
