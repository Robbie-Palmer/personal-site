...
* **Cons**: Most features target "no-code" or marketing teams, which is overkill for this project. Adds an entirely new platform (accounts, billing, tokens) which violates [Minimize Platforms](/projects/personal-site/index.mdx#minimize-platforms-maximize-velocity).
