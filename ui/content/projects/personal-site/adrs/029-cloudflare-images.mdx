...
* **Cons**: Most features target "no-code" or marketing teams, which is overkill for this project. Adds an entirely new platform (accounts, billing, tokens) which violates [Minimize Platforms](/projects?tab=philosophy#minimize-platforms).
