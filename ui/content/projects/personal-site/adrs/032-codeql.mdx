...
2. **Minimal Overhead**: Avoid introducing another external dashboard or login (e.g., Snyk, SonarQube) to adhere to [Minimize Platforms](/projects/personal-site/index.mdx#minimize-platforms-maximize-velocity).
