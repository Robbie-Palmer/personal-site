...
2. **Minimal Overhead**: Avoid introducing another external dashboard or login (e.g., Snyk, SonarQube) to adhere to [Minimize Platforms](/projects?tab=philosophy#minimize-platforms-maximize-velocity).
