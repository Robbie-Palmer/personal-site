...
findings record posture regressions for weekly triage. Treat them like Trivy's
scheduled scans in the Security tab. Several checks, including branch protection
and token permissions, concern settings PRs cannot
change anyway.
