...
I will trial **CCPM** (Claude Code Project Management - `https://github.com/automazeio/ccpm/`) as my primary issue tracking tool.
...
* **Risk**: CCPM is an immutable/unstable tool. I may need to fork it or rewrite parts of it myself.
