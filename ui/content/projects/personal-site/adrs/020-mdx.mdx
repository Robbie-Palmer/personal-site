...
With [Static Site Generation](/projects/personal-site/adrs/014-ssg) as the rendering strategy, I need a content format that balances **simplicity for prose** with **power for interactive content**:
...
* [Claude Code](/projects/personal-site/adrs/011-claude-code) readable and editable
...
* **Why not**: Violates "content as code" from [ADR 014](/projects/personal-site/adrs/014-ssg). Git versioning is superior, free, and avoids vendor lock-in.
...
* **AI-Native Workflow**: [Claude Code](/projects/personal-site/adrs/011-claude-code) reads/edits MDX as easily as TypeScript. [CodeRabbit](/projects/personal-site/adrs/008-coderabbit) reviews for grammar, SEO, broken links, content quality.
...
* **Boring Technology**: Standard for technical content in React/Next.js ecosystem. Massive community and LLM knowledge.
