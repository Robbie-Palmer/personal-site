...
* **Agentic Optimization**: Terraform's HCL is the ubiquitous industry standard, a [The Goldilocks Zone](/projects?tab=philosophy#the-goldilocks-zone). Coding agents understand it well, thanks to the massive volume of public examples. This outweighs the desire for TypeScript-based IaC.
