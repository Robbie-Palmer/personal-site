...
* **[Minimize Platforms](/projects?tab=philosophy#minimize-platforms)**: Dependabot is built into GitHub—no additional service to sign up for, configure, or maintain. Zero external dependencies means one less thing to manage.
...
* **[Boring Technology](/projects?tab=philosophy#choose-boring-technologies)**: Dependabot is the default, widely used solution. It "just works." Choosing the obvious, stable tool means less cognitive overhead and more energy for innovation where it actually matters.
