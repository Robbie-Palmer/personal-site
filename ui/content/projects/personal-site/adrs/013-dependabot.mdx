...
* **Limited Semver Awareness**: Dependabot doesn't respect semver ranges in package.json when proposing updates, leading to unwanted major version bumps (addressed later in ADR 022).
