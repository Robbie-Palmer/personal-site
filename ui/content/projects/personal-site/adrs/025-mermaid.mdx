...
Here's a flowchart demonstrating Mermaid's capabilities for visualizing a software deployment pipeline:
...
- Multiple node shapes (rectangles, diamonds for decisions)
- Directional flow with labeled edges
- Conditional branches (pass/fail, approved/rejected)
- Styling individual nodes with colors
