...
* **Sugar High**: Fast (\~2KB), but only supports JavaScript/TypeScript and lacks broad language coverage
...
* **Large Bundle**: \~250KB for Shiki + WASM dependencies, considerably larger than Prism (\~5KB). However, this is acceptable because highlighting runs at build-time. The bundle never ships to the client.
