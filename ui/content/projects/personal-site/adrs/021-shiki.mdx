...
This aligns with [Choose Boring Technologies](/projects?tab=philosophy#choose-boring-technologies) and [LLM-Optimized](/projects?tab=philosophy#llm-optimized). Shiki uses VS Code's battle-tested syntax engine and theme ecosystem, both of which have massive LLM training data. The build-time approach eliminates client-side performance concerns.
