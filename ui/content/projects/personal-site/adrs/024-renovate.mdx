...
* **External Platform**: Renovate runs as a GitHub App, adding a dependency on an external service (though still tightly integrated with GitHub). This slightly deviates from [Minimize Platforms](/projects?tab=philosophy#minimize-platforms), but the velocity gains justify the tradeoff.
