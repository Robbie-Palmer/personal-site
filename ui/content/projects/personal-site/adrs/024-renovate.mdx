...
date: "2025-11-02"
status: "Accepted"
supersedes: "personal-site:013-dependabot"
tech_stack: ["Renovate"]
---
...
* **Still Boring Technology**: Renovate is widely used, well-documented, and has strong AI/LLM training data. It's the industry standard for teams that need more control than Dependabot provides.
...
* **External Platform**: Renovate runs as a GitHub App, adding a dependency on an external service (though still tightly integrated with GitHub). This slightly deviates from [Less Is More](/projects?tab=philosophy#less-is-more), but the velocity gains justify the tradeoff.
