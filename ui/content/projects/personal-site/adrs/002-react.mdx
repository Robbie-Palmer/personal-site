...
* **vs Vanilla JS**: React provides the declarative model and component boundries required for complex applications. The "overhead" of the runtime is paid back in maintainability once the application exceeds trivial complexity
