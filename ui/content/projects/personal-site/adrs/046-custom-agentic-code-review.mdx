...
This challenges the normal preference to buy rather than build. A focused vendor should typically produce a better product through domain expertise and sustained investment. Coding agents change the implementation economics: a narrow workflow tailored to one repository can now be created and changed cheaply, while SaaS vendors must price and design for a much broader market. That does not make custom software automatically better; it makes a bounded experiment economically credible.
