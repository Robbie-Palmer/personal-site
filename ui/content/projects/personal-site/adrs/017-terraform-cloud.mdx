...
Remote state storage is a necessity. To achieve my [Maximize Velocity](/projects?tab=philosophy#minimize-platforms-maximize-velocity) and [Ship Incrementally](/projects?tab=philosophy#ship-incrementally) principles, infrastructure changes must happen via CI/CD pipelines. This requires a shared, accessible state backend that the runner can verify and update.
...
This violates my [Minimize Platforms, Maximize Velocity](/projects?tab=philosophy#minimize-platforms-maximize-velocity) principle by adding "meta-infrastructure" that needs to be maintained just to maintain the actual infrastructure.
