...
Remote state storage is a necessity. To achieve my [Fast Feedback Loops](/projects?tab=philosophy#fast-feedback-loops) and [Ship Incrementally](/projects?tab=philosophy#ship-incrementally) principles, infrastructure changes must happen via CI/CD pipelines. This requires a shared, accessible state backend that the runner can verify and update.
...
This violates my [Minimize Platforms](/projects?tab=philosophy#minimize-platforms) principle by adding "meta-infrastructure" that needs to be maintained just to maintain the actual infrastructure.
