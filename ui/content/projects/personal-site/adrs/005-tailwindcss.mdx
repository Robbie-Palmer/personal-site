...
Styling directly in the markup eliminates context switching—tighter [Fast Feedback Loops](/projects?tab=philosophy#fast-feedback-loops). Constrained tokens enforce a design system.
