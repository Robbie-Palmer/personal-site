...
* **[Choose Boring Technologies](/projects?tab=philosophy#choose-boring-technologies)**: GitHub is the default, status quo choice for open source software. It is reliable, well-understood, and ubiquitous.
...
* **[Minimize Platforms](/projects?tab=philosophy#minimize-platforms)**: I already use GitHub for my professional work and other open source contributions. Using it here avoids creating a new account or learning a new interface.
