...
* **Alignment with Principles**:
  ...
  * **[Minimize Platforms](/projects?tab=philosophy#minimize-platforms)**: CodeRabbit integrates directly into the GitHub PR interface. I do not need to visit a separate dashboard; the feedback comes to where the work is happening.
