...
* **Complexity**: It requires setting up and maintaining an artifact store (npm/pypi packages) to share code, adds unnecessary overhead—[Less Is More](/projects?tab=philosophy#less-is-more)—for a personal project where velocity is paramount.
