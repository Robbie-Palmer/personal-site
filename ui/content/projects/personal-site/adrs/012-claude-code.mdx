...
* **Velocity**: I can ship features considerably faster by delegating implementation details.
...
* **Guardrails**: Necessitates robust testing \[ADR 008] and review \[ADR 009] to verify the agent's output.
