...
Recharts is a composable charting library built on React components. It uses SVG for rendering, which offers strong scalability and accessibility.

## Interactive Demo

Here are a few chart types built with Recharts, demonstrating the composable API:
...
* **Cons**: Considerably less popular than Recharts, and their example page is much less impressive. Can be verbose.
...
* **Pros**: Canvas-based (great for massive datasets with thousands of points), large ecosystem.
