...
Here's a live interactive chart demonstrating Recharts' composable API:
...
**Try it yourself:** Hover over the chart to see interactive tooltips with data values.

This example showcases:
- **Composable components**: `<LineChart>`, `<Line>`, `<XAxis>`, `<YAxis>` compose naturally
- **Responsiveness**: Chart automatically adapts to container size
...
- **Built-in interactions**: Hover tooltips and legend with zero extra configuration
- **Theme-aware**: Colors adapt to dark/light mode using CSS variables
