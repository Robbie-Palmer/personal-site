...
Here's a code example demonstrating Recharts' composable component API:
...
- **Responsiveness**: `<ResponsiveContainer>` makes charts adapt to container size
- **Multiple data series**: Three lines (revenue, expenses, profit) from a single dataset
- **Customization**: Color values, stroke widths, and other styling options
- **Built-in interactions**: Hover tooltips and legend with minimal configuration
