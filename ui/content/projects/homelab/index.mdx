...
declares the host, and an independent single-node K3s cluster runs t3-code for
one operator. Multi-user capacity belongs on dedicated workspace nodes in a
separately tested cluster, not on this VPS.
