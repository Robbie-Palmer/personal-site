...
I have an Asus desktop with a GTX 1050, Pascal-era (`sm_61`), released 2016,
...
* **Wake-on-LAN** on the real interface plus BIOS power-on-by-PCI-E, so the
  ...
  has no ethernet path to the router, and its uplink is USB tethering to a
  Pixel phone, which drops in sleep and can't carry a magic packet. The WoL
