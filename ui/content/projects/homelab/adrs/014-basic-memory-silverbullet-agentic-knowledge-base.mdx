...
collections of Space Lua, templates, and pages, typically through Git-backed
...
<div className="overflow-x-auto">
  ...
  | **Basic Memory + Obsidian Sync** | `++` MCP, CLI, files, Obsidian CLI | `++` canonical Markdown                    | `++` native Mac/Linux/Android      | `+` large registry; much relevant overlap        | `+` E2EE, $4–5/month       | Fallback     |
...
* **Pros**: Keeps Obsidian's strong native clients, graph, plugin ecosystem,
...
* **Pros**: Already familiar, polished everywhere, free for an individual with
  ...
  markedly more agent-friendly than when I last used it.
