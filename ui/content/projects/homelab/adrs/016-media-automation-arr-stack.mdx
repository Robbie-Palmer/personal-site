...
supply. Every episode meant finding a torrent by hand, waiting for it in a
GUI client, renaming the file to something Jellyfin parses, moving it into
the right season folder, and rescanning the library — toil I would repeat
weekly for every show in the library.
