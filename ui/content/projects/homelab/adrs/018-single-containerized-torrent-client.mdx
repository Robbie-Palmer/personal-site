...
* **Decision**: Rejected. qBittorrent's API matches the \*arr stack. A niche
  client would add integration work without saving meaningful resources.
