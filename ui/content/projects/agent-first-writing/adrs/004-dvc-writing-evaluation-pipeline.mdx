...
4. `match_edits` aligns suggestions with accepted, rejected, and changed edits
   and the final published diff. It keeps unmatched and ambiguous cases
   separate instead of counting them as rejections.
