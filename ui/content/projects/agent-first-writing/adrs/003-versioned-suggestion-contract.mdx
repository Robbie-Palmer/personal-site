...
outcome. A changed decision stores the replacement the user chose. Preserve the
original suggestion, schema version, producer version, and source revision so
later evaluations compare like with like.
