...
replacements, reasons, confidence, and edit outcomes. Grammarly does not expose
the API required to make those capabilities part of this system. We cannot use
its private product as reproducible architecture.
