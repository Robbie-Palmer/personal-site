...
Version 1 of the suggestion contract now lives in the shared
`writing-editor-domain` package. It hashes exact source bytes, uses half-open
UTF-8 spans, groups suggestions under stable proposal IDs, and keeps the full
...
pinned Git commits and freezes a 5/2/2 train, development, and holdout cohort.
