...
[ADR 032](/projects/personal-knowledge-graph/adrs/032-codeql)), dependencies and IaC
(Trivy, [ADR 047](/projects/personal-knowledge-graph/adrs/047-trivy)), and workflow
*content* (zizmor, [ADR 049](/projects/personal-knowledge-graph/adrs/049-zizmor)). Each
...
* Actions SHA-pinned like everything else
  ([ADR 049](/projects/personal-knowledge-graph/adrs/049-zizmor)); Renovate keeps the
  digests fresh.

Scorecard is a *meta-check*: it is deliberately **not blocking** on PRs. Its
findings record existing posture weaknesses and regressions for weekly triage.
Treat them like Trivy's scheduled scans in the Security tab. Workflow permissions
live in version-controlled YAML and should be fixed promptly through PRs. Branch
protection is a repository setting and needs separate remediation.
...
enough to trust, standard enough that the badge means something to a reader. It
comfortably sits inside the [Goldilocks zone](/projects?tab=philosophy#the-goldilocks-zone).
...
* [Build Flywheels](/projects?tab=philosophy#build-flywheels). The hardening
  ...
  one-time effort; each future repo inherits the rubric without setup.
* [Respect Goodhart's Law](/projects?tab=philosophy#respect-goodharts-and-conways-laws).
  Treat the score as a diagnostic. Checks we deliberately skip, e.g.
