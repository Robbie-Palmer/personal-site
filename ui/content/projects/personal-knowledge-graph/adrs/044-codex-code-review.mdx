...
[ADR 009: CodeRabbit](/projects/personal-knowledge-graph/adrs/009-code-rabbit) records the core decision to use automated review. [ADR 041: Gemini Code Assist](/projects/personal-knowledge-graph/adrs/041-gemini-code-assist) and [ADR 042: Greptile](/projects/personal-knowledge-graph/adrs/042-greptile) record the value of independent reviewers, divergent feedback, and provider resilience. This ADR does not repeat that rationale.

[ADR 043: Codex](/projects/personal-knowledge-graph/adrs/043-codex) introduces a ChatGPT Plus subscription for agentic coding. That plan also includes **Codex code review in GitHub**, including automatic Pull Request reviews, without another subscription.
