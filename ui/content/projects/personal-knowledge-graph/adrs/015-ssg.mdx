...
[Next.js](/projects/personal-knowledge-graph/adrs/003-next-js) supports multiple rendering strategies, each with different trade-offs:
...
* **Simplicity**: Minimal infrastructure to maintain
...
All pages are pre-rendered at build time and served as static HTML from [Cloudflare Pages](/projects/personal-knowledge-graph/adrs/010-cloudflare-pages)' global CDN. Content lives as MDX files in the git repository, making the entire site "content as code."
...
* **[The Goldilocks Zone](/projects?tab=philosophy#the-goldilocks-zone)**: Serving static files from a CDN is the most proven pattern in web infrastructure. Mature and reliable.
