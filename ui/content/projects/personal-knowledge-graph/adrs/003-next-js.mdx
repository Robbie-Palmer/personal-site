...
With **React** selected as the UI library (see [ADR 002](/projects/personal-knowledge-graph/adrs/002-react)), I need a meta-framework to handle routing, building, and rendering.
