...
* **Cons**: Requires a runtime, breaking [Static Site Generation](/projects/personal-knowledge-graph/adrs/015-ssg). Would need either Vercel or Cloudflare Workers (via [`@opennextjs/cloudflare`](https://opennext.js.org/cloudflare)).
