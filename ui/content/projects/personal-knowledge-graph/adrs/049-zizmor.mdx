...
[ADR 048 (SonarQube)](/projects/personal-knowledge-graph/adrs/048-sonarqube) framed the
...
CodeQL does dataflow SAST on TS/JS ([ADR 032](/projects/personal-knowledge-graph/adrs/032-codeql)),
Trivy covers IaC/deps/containers ([ADR 047](/projects/personal-knowledge-graph/adrs/047-trivy)),
...
flags on one PR may not be flagged on the next. In practice there is no
...
freshness ([ADR 024](/projects/personal-knowledge-graph/adrs/024-renovate)).

# Decision

Adopt two deterministic, GitHub-native tools for the workflow layer, both
managed through [mise](/projects/personal-knowledge-graph/adrs/004-mise) so what runs in CI
runs identically on a laptop ([ADR 016](/projects/personal-knowledge-graph/adrs/016-github-actions)):
...
* **zizmor**, a dedicated static analyzer (SAST) for GitHub Actions. It runs as
  ...
  Trivy ([ADR 047](/projects/personal-knowledge-graph/adrs/047-trivy)), GitHub Code Scanning
...
actionlint and zizmor cover different concerns. actionlint catches correctness
problems such as a mistyped expression or invalid `runs-on`, while zizmor catches
...
Weighted toward the same test as [ADR 047](/projects/personal-knowledge-graph/adrs/047-trivy):
