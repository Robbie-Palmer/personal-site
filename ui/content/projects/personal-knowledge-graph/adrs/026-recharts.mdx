...
I am migrating a "How to Build Wealth" blog post that was originally written as a Jupyter notebook on fastpages with plots generated using Altair. I need a charting library that integrates deeply with my [React](/projects/personal-knowledge-graph/adrs/002-react) and [Next.js](/projects/personal-knowledge-graph/adrs/003-next-js) stack.
...
* **Customizability**: Ability to style charts to match the site's [Tailwind CSS](/projects/personal-knowledge-graph/adrs/005-tailwindcss) design system.
