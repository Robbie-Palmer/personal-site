...
* Demonstrate the depth of the knowledge graph to visitors
...
* **D3.js** (`d3-force`): The foundational force simulation library. Maximum flexibility but low-level. It requires manual rendering, zoom/pan, and React integration. Fights React's declarative model over DOM ownership.
