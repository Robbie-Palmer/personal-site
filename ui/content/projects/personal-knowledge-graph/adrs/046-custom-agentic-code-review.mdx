...
[ADR 009: CodeRabbit](/projects/personal-knowledge-graph/adrs/009-code-rabbit) records why this project uses automated review. [ADR 041: Gemini Code Assist](/projects/personal-knowledge-graph/adrs/041-gemini-code-assist), [ADR 042: Greptile](/projects/personal-knowledge-graph/adrs/042-greptile), [ADR 044: Codex Code Review](/projects/personal-knowledge-graph/adrs/044-codex-code-review), and [ADR 045: Qodo](/projects/personal-knowledge-graph/adrs/045-qodo) record the successive attempts to maintain diverse review coverage. This ADR does not repeat that rationale.
...
* **Decision**: Rejected. Limit the scope to this repository's review loop and leave general CodeRabbit competition out of it.
