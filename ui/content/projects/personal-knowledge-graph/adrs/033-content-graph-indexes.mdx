...
[SSG constraint](/projects/personal-knowledge-graph/adrs/015-ssg) of building everything at compile time.
...
**Composite NodeIds** (`"project:personal-knowledge-graph"`) provide:
...
**Why not now**: We can replicate the useful relationship handling
(bidirectional queries, referential integrity) in TypeScript with full type safety.
The "content as code" principle from [ADR 015](/projects/personal-knowledge-graph/adrs/015-ssg) is more valuable for this project.
