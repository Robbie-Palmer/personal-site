...
With [Static Site Generation](/projects/personal-knowledge-graph/adrs/015-ssg) as the rendering strategy, I need a content format that balances **simplicity for prose** with **power for interactive content**:
...
* [Claude Code](/projects/personal-knowledge-graph/adrs/012-claude-code) readable and editable
...
* **Why not**: Violates "content as code" from [ADR 015](/projects/personal-knowledge-graph/adrs/015-ssg). Git versioning is superior, free, and avoids vendor lock-in.
...
* **AI-Native Workflow**: [Claude Code](/projects/personal-knowledge-graph/adrs/012-claude-code) reads/edits MDX as easily as TypeScript. [CodeRabbit](/projects/personal-knowledge-graph/adrs/009-coderabbit) reviews for grammar, SEO, broken links, content quality.
