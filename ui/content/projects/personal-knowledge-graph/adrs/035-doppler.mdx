...
As the number of external service integrations grows beyond the current minimal set ([Cloudflare Pages](/projects/personal-knowledge-graph/adrs/011-cloudflare-pages)/[Images](/projects/personal-knowledge-graph/adrs/029-cloudflare-images), [Terraform Cloud](/projects/personal-knowledge-graph/adrs/017-terraform-cloud)), secret management complexity increases proportionally.
...
Currently, [GitHub Secrets (ADR 018)](/projects/personal-knowledge-graph/adrs/018-github-secrets) handles secret management well for CI/CD pipelines.
