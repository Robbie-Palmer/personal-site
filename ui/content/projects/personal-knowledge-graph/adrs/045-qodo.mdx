...
Qodo, CodeRabbit, Greptile, and the other evaluated services.

# Context

[ADR 009: CodeRabbit](/projects/personal-knowledge-graph/adrs/009-code-rabbit) records the decision to use automated AI review on Pull Requests. [ADR 041: Gemini Code Assist](/projects/personal-knowledge-graph/adrs/041-gemini-code-assist), [ADR 042: Greptile](/projects/personal-knowledge-graph/adrs/042-greptile), and [ADR 044: Codex Code Review](/projects/personal-knowledge-graph/adrs/044-codex-code-review) record why multiple review providers improve coverage and resilience. This ADR does not repeat that rationale.
