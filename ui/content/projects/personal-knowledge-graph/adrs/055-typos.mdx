...
stack's standard determinism argument ([ADR 048](/projects/personal-knowledge-graph/adrs/048-sonarqube))
...
* **Corpus updates can add findings**: a mise version bump may flag words it
  ...
  ([ADR 024](/projects/personal-knowledge-graph/adrs/024-renovate)).
