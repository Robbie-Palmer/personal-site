...
Some technical debt is useful. Treat it as a deliberate tool instead of a moral failure.
...
People fill time with what's available, bikeshedding, process tweaks, planning in isolation from the work.
...
That value has a short shelf life.
...
Documentation grows and gets abandoned. Minimize it where possible.
...
[Goodhart's Law](/ideas/goodharts-law): when a measure becomes a target, it ceases to be a good measure.
Do not hold people to account for proxies.

[Conway's Law](/ideas/conways-law): systems mirror the communication structures of the organizations that build them.
