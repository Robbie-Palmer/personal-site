...
establish the platform decisions that shape the implementation: the public
...
[ADR 032](/projects/agentic-code-review/adrs/032-stateful-ai-code-review).
[ADR 014](/projects/agentic-code-review/adrs/014-cloudflare-workflows) records
the Workflow decision locally because no earlier project-neutral ADR captures
the orchestration and retry boundaries used by code review.
