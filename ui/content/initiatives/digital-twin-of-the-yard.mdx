...
Yard --> Mobile["Mobile observations"]
Documents["Bills of lading"] --> Extraction["Document extraction"]
Fixed --> Events["Shared events and identifiers"]
Mobile --> Events
Extraction --> Events
Systems["TMS, YMS and WMS"] <--> Events
Events --> Twin["Yard ontology and live twin"]
Twin --> Operations["Real-time decisions"]
Twin --> History["Historical analysis"]
Operations --> Yard
History --> Improvements["Workflow and capacity changes"]
Improvements --> Yard
`}
/>
