...
> **Note:** This article was originally published on [Confluent's blog](https://www.confluent.io/blog/uniting-machine-learning-data-streaming-1/) while I was working with them. I've adapted it here for my personal blog to serve as a single source of truth for my writing on machine learning and data streaming.
...
**Azure**
- Cognitive Search Sink Connector
- Data Lake Storage Gen2 Sink Connector
- Synapse Analytics Sink Connector

**Google Cloud**
- BigQuery Sink Connector
- BigTable Sink Connector
...
- DataRobot's Apache Kafka Spooler
- Pachyderm's Spouts
