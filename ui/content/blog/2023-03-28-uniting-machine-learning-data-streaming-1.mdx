...
technologies: ["Kafka", "Python", "Java"]
role: "Confluent"
canonical: "https://www.confluent.io/blog/uniting-machine-learning-data-streaming-1/"
image: "blog/uniting-machine-learning-data-streaming-1-featured-2025-12-14"
imageAlt: "Colourful streams flowing into a neural network like structure containing nodes and connections"
---

***

**📝 Note:** Originally published on [Confluent's blog](https://www.confluent.io/blog/uniting-machine-learning-data-streaming-1/). Republished here as part of my writing portfolio.
...
The ML market is rapidly reaching an inflection point. The [2022 NewVantage Data and AI Survey](https://c6abb8db-514c-4f5b-b5a1-fc710f1e464e.filesusr.com/ugd/e5361a_2f859f3457f24cff9b2f8a2bf54f82b7.pdf) shows the continued massive investment in AI, with 96% of respondents having initiatives in limited production, but only 26% have widespread deployments. This number is rapidly improving, but these organizations are feeling intense growing pains. Few identify as being data-driven. Most are struggling to introduce new roles such as Chief Data and Analytics Officer (CDAO) with high turnover, and almost all surveyed executives identified culture as their most significant impediment. This marks the challenging shift from centralized data warehouses and data lakes to federated data products. The challenging shift towards embracing the [Modern Data Flow](https://www.confluent.io/en-gb/blog/data-flow-the-key-to-modern-data-pipelines/).
...
>
> — [Chip Huyen, Co-founder, Claypot AI](https://huyenchip.com/2020/12/27/real-time-machine-learning.html)
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="blog/confluent-ml-data-mesh-2025-12-14" alt="Data mesh architecture diagram showing Kafka as central nervous system" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
<Mermaid
  chart={`graph BT
Sensors["📡 Source Systems"]:::input
Actuators["🎯 Applications"]:::app

CNS["⚡ Apache Kafka"]:::storage
...
>
> — [Kai Waehner, Field CTO, Confluent](https://www.confluent.io/blog/build-deploy-scalable-machine-learning-production-apache-kafka/)
...
Most model training platforms encourage you to export your ML model as a Docker container with an HTTP API slapped in front of it. The HTTP protocol was designed for web browsing. It handles rapid transfers of large data volumes poorly. The Kafka protocol is much more suitable for this use case. It is a binary TCP protocol optimized for efficiency, which groups messages together to reduce network overhead.
...
Databases are typically optimized for live operations rather than longer-term analytics, which means they are designed to store only the current state. This makes working with historical data challenging, with most data warehouses deciding to tally aggregates of what is deemed essential features. This loses detail because designers can preserve only the features they know about today. It cannot anticipate future unknowns. The use cases of the future need to tap into the data of the past.
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="blog/confluent-stream-lineage-2025-12-14" alt="Screenshot of Confluent Cloud Stream Lineage feature showing data flow visualization" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
We've examined the harmony between these ecosystems and their vast potential to disrupt existing solutions. Why isn't this the prevailing paradigm, then? Inertia always plays a part, and data streaming is a market still in its infancy, with a path of enormous growth ahead. But the uniting of these markets has been too slow (given their synergies) to simply be inertia. We face critical socio-technical barriers that reinforce each other in a cycle driven by a lack of a common tongue.
...
>
> — [Roman Pichler, Founder, Pichler Consulting](https://www.romanpichler.com/blog/feature-teams-vs-component-teams/)

<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="blog/team-architecture-challenges-2025-12-14" alt="Diagram comparing component teams vs feature teams organizational structures" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
