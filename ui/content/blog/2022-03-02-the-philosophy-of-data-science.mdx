...
Unlike Logical Positivism, it doesn't define this as meaningless.
...
Both Positivists and Critical Rationalists believe that science at its most paradigm-shifting, just as much as normal science,
comes about by the same means, with revolutions sought, promoted and welcomed.
...
Kuhn believed this translation wasn't impossible, just extremely difficult.
...
Kuhn claims "revisionary change" is a necessary condition for change that overthrows a paradigm.
...
difference in semantics over what counts as a genuine paradigm shift.
...
Wolfram claims that many common systems have no traditional mathematical formulas that
readily describe their overall behaviour, and that this is a consequence of computational irreducibility.
...
DDD doesn't escape the challenges raised by post-positivism, but it does aid engineers / scientists in addressing them to continue to make "normal progress".
