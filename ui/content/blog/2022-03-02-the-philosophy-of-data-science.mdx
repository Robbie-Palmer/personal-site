...
ideas: ["bounded-context", "domain-driven-design", "data-mesh"]
...
equivalent term from [Domain-Driven Design](/ideas/domain-driven-design),
its [Bounded Context](/ideas/bounded-context).
