...
date: "2021-12-10"
tags: ["software"]
image: "blog/just-right-engineering-featured-2025-12-14"
imageAlt: "A stack of balanced stones with a laptop balanced on top"
---
...
Their mindset may be what is needed for say; a clinical grade medical device running on embedded devices.

An under-engineer will completely fail to improve a vast complex system and so in that context won't deliver anything of
value.

Their mindset may be what is needed for say; building a new fan site for a buzzing hot topic, where time is of
the essence, and flare is more valued by users than robustness.

All engineers can be "just right engineers" by moving to an appropriate environment.
In practice, few will slot into a perfect role for their default make-up.
...
* This approach is high risk, high reward. No low risk, high reward alternatives exist, so let's commit.
...
The key is applying the **art of engineering**
