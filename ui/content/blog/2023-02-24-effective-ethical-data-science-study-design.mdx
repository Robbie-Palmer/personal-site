...
ideas: ["ontology-engineering"]
image: "blog/effective-ethical-data-science-study-design-featured-2025-12-14"
imageAlt: "Traditional golden scales sitting next to a laptop"
---
...
You can choose from a variety of statistical study methodologies,
...
Experimental design poses many additional challenges for determining causality reliably.
...
Some subgroups may be small, and to include them in your sample with their appropriate ratio,
...
Quota sampling closely resembles [stratified sampling](#stratified-sampling).
...
as some onta may be present in small proportions of the population.
...
and remain unaccounted for. Defining your ontology from the status quo is a conservative political choice.
...
Ethical oversights extend beyond Data Science research and into applied Data Science.
...
Yet redefining our problems around new data samples and ontologies
...
An underlying culturally embedded art is at play in our decision-making,
...
No objectively correct data waits to be analysed without data sampling first.
...
Yet they cannot deny the increasingly evidenced power of the frequentist approaches taken by machine learning.
...
A Data Scientist should consider many questions:
