...
image: "/blog-images/automatically-detect-pii-real-time-cyber-defense-featured.jpg"
imageAlt: "Digital security shield and lock representing cybersecurity and data protection"
---

***

**📝 Note:** Originally published on [Confluent's blog](https://www.confluent.io/blog/pii-detection-real-time-cyber-defense/). Republished here as part of my writing portfolio.
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="/blog-images/pii-central-nervous-system.png" alt="Diagram showing stream processing and ML augmenting SIEM solutions" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="/blog-images/pii-anon-data.png" alt="Screenshot of Confluent Cloud showing redacted PII data stream" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="/blog-images/pii-udfs-1.png" alt="Screenshot showing PII UDF query results with contains_pii and redacted_log columns" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="/blog-images/pii-udfs-2.png" alt="Screenshot showing PII extraction query results with entity types and values" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '1.5rem 0', gap: '0'}}>
  <img src="/blog-images/pii-detection-solutions.jpg" alt="Overview diagram of PII detection solutions: Stream Processing App, ksqlDB UDFs/UDTFs, and Kafka Connect SMT" style={{margin: '0', display: 'block', maxWidth: '100%'}} />
