...
> **Note:** This article was originally published on [Confluent's blog](https://www.confluent.io/blog/pii-detection-real-time-cyber-defense/) while I was working with them. I've adapted it here for my personal blog to serve as a single source of truth for my writing on data governance and cybersecurity.
...
These PII Detection solutions support 25 entity types out of the box, including PCI (such as credit card numbers) and country-specific entities (such as U.S. Social Security numbers). The full list of entities includes:
...
- Confluent solution page on SIEM
- Video: How to optimize your SIEM platforms
