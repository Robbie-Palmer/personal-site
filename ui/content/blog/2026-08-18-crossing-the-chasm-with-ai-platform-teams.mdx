...
Over 50 years of literature backs this up, along with 10 years of personal experience with teams that adopted these strategies and teams that went against them.
...
Use GitLab instead of GitHub; use Linear instead of Jira.
...
They haven't landed yet; they're alpha, or limited access, or sometimes they got it wrong and didn't actually solve the problem.
...
Who on earth do you buy from now?
...
Who will do it and when it will land is unknown.
...
The studios that waited got the platform layer free of charge.
Nobody actually waited, though: Doom, Warcraft, and Duke Nukem were all built in those years, on middleware everyone knew was temporary.

Now we have to invest in an AI platform team to bring the company into this new world, knowing it should become redundant in several years when the market settles.
