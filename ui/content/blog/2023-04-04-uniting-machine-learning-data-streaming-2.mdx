...
> **Note:** This article was originally published on [Confluent's blog](https://www.confluent.io/blog/uniting-machine-learning-data-streaming-2/) while I was working with them. I've adapted it here for my personal blog to serve as a single source of truth for my writing on machine learning and data streaming.
